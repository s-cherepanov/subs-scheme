...
#ifndef NUMBERNATIVEFUNCTIONVALUE_H
#define NUMBERNATIVEFUNCTIONVALUE_H
...
class NumberNativeFunctionValue : public NativeFunctionValue
{
public:
    virtual std::auto_ptr<Value> Run( EvaluationContext& ev,
        const CombinationValue* argvalues ) const;

    virtual NumberNativeFunctionValue* Clone() const;
