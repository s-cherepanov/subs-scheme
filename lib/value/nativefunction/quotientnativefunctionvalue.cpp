...
//virtual
std::auto_ptr<Value> QuotientNativeFunctionValue::Run(
...
//virtual
QuotientNativeFunctionValue* QuotientNativeFunctionValue::Clone() const
{
    return new QuotientNativeFunctionValue( *this );
}


//virtual
std::string QuotientNativeFunctionValue::GetName() const
{
    return StaticName();
}

//static
const std::string& QuotientNativeFunctionValue::StaticName()
{
    static const string static_name( "quotient" );
    return static_name;
}
