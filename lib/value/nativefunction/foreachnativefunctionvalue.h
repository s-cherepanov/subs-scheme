...
#ifndef FOREACHNATIVEFUNCTIONVALUE_H
#define FOREACHNATIVEFUNCTIONVALUE_H
...
class ForEachNativeFunctionValue : public NativeFunctionValue
{
public:
    virtual std::auto_ptr<Value> Run( EvaluationContext& ev,
        const CombinationValue* argvalues ) const;

    virtual ForEachNativeFunctionValue* Clone() const;
