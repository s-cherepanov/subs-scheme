...
#ifndef SYMBOLNATIVEFUNCTIONVALUE_H
#define SYMBOLNATIVEFUNCTIONVALUE_H
...
class SymbolNativeFunctionValue : public NativeFunctionValue
{
public:
    virtual std::auto_ptr<Value> Run( EvaluationContext& ev,
        const CombinationValue* argvalues ) const;

    virtual SymbolNativeFunctionValue* Clone() const;
