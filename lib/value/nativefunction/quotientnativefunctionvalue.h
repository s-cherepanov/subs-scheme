...
#ifndef QUOTIENTNATIVEFUNCTIONVALUE_H
#define QUOTIENTNATIVEFUNCTIONVALUE_H
...
class QuotientNativeFunctionValue : public NativeFunctionValue
{
public:
    virtual std::auto_ptr<Value> Run( EvaluationContext& ev,
        const CombinationValue* argvalues ) const;

    virtual QuotientNativeFunctionValue* Clone() const;
